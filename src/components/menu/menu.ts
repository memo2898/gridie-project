  ...
  private getMenuItems(): MenuItem[] {
    return [
      ...
      },
      {
        ...
        children: [
          {
            label: "8.1 Basic Pagination",
            path: "/8_Paging/basic_pagination",
          },
          {
            label: "8.2 Pagination External Controls",
            path: "/8_Paging/pagination_external_controls",
          },
          {
            label: "8.3 Pagination Jump Control",
            path: "/8_Paging/pagination_jump_control",
          },
          {
            label: "8.4 Pagination Positions",
            path: "/8_Paging/pagination_positions",
          },
          {
            label: "8.5 Pagination with Filters",
            path: "/8_Paging/pagination_with_filters",
          },
        ],
      },
      {
